    ...
    public class PrestamosPresentacion : IPrestamosPresentacion
    {
        ...
        public async Task<List<Prestamos>> Listar()
        {
            ...
            await auditor.RegistrarAsync(new Auditorias
            {
                ...
                DatosAntes = null,
                DatosDespues = $"Se listaron {lista.Count} Prestamos.",
        ...
        public async Task<List<Prestamos>> PorPrestamos(Prestamos? entidad)
        {
            var datos = new Dictionary<string, object>();
            datos["Entidad"] = entidad!;

            comunicaciones = new Comunicaciones();
            datos = comunicaciones.ConstruirUrl(datos, "Prestamos/PorPrestamos");
            var respuesta = await comunicaciones!.Ejecutar(datos);
        ...
        public async Task<Prestamos?> Modificar(Prestamos? entidad)
        {
            ...
            var entidadNueva = JsonConversor.ConvertirAObjeto<Prestamos>(
                JsonConversor.ConvertirAString(respuesta["Entidad"]));
        ...
        public async Task<Prestamos?> Borrar(Prestamos? entidad)
        {
            ...
            var resultado = JsonConversor.ConvertirAObjeto<Prestamos>(
                JsonConversor.ConvertirAString(respuesta["Entidad"]));

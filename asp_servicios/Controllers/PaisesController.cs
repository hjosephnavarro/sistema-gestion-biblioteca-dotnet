...
namespace asp_servicios.Controllers
{
    ...
    {
        private readonly IPaisesAplicacion _iAplicacion;
        private readonly TokenController _tokenController;

        public PaisesController(IPaisesAplicacion iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            try
            {
                ...
                var entidadJson = datos.ContainsKey("Entidad") && datos["Entidad"] != null
                    ...
                    : "{}";
                var entidad = JsonConversor.ConvertirAObjeto<Paises>(entidadJson);
                ...
                if (existentes.Any(x =>
                    x.Nombre_Pais.Trim().ToLower() == entidad.Nombre_Pais.Trim().ToLower()))
                {
                    throw new Exception("Ya existe un país con el mismo nombre.");
                }
        ...
        public string Modificar()
        {
            try
            {
                ...
                if (existentes.Any(x =>
                    ...
                    x.Nombre_Pais.Trim().ToLower() == entidad.Nombre_Pais.Trim().ToLower()))
                {
                    throw new Exception("Ya existe otro país con el mismo nombre.");
                }

...
namespace asp_servicios.Controllers
{
    ...
    {
        private readonly IAutoresAplicacion _iAplicacion;
        private readonly TokenController _tokenController;

        public AutoresController(IAutoresAplicacion iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Autores>(entidadJson);

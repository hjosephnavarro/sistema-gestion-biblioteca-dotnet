...
namespace asp_servicios.Controllers
{
    ...
    public class EstadosExistenciasController : ControllerBase
    {
        private readonly IEstadosExistenciasAplicacion _iAplicacion;
        private readonly TokenController _tokenController;

        public EstadosExistenciasController(IEstadosExistenciasAplicacion iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<EstadosExistencias>(entidadJson);

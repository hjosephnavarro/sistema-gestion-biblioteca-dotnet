...
namespace asp_servicios.Controllers
{
    ...
    {
        private readonly ITemasAplicacion _iAplicacion;
        private readonly TokenController _tokenController;

        public TemasController(ITemasAplicacion iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            try
            {
                ...
                var entidadJson = datos.ContainsKey("Entidad") && datos["Entidad"] != null
                    ...
                    : "{}";
                var entidad = JsonConversor.ConvertirAObjeto<Temas>(entidadJson);
                ...
                // Validación: no duplicar nombre de tema
                if (existentes.Any(x =>
                    x.Nombre_Tema.Trim().ToLower() == entidad.Nombre_Tema.Trim().ToLower()))
                {
        ...
        public string Modificar()
        {
            try
            {
                ...
                if (existentes.Any(x =>
                    ...
                    x.Nombre_Tema.Trim().ToLower() == entidad.Nombre_Tema.Trim().ToLower()))
                {
                    throw new Exception("Ya existe otro tema con ese nombre.");
                }
